...
{
    public record UpdateLearningProgressCommand(int idProgress, short learningProgress) : IRequest<LessonProgressDto>;
        ...
        : IRequestHandler<UpdateLearningProgressCommand, LessonProgressDto>
    {
        ...
        {
            return repository.UpdateLearningProgress(request.idProgress, request.learningProgress);
        }
    }
}
